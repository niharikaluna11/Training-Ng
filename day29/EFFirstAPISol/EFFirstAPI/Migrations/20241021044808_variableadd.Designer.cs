...
namespace EFFirstAPI.Migrations
{
    ...
    [Migration("20241021044808_variableadd")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFFirstAPI.Models.CartItem", b =>
                {
                    b.Property<int>("SNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFFirstAPI.Models.OrderDetail", b =>
                {
                    b.Property<int>("SNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFFirstAPI.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFFirstAPI.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFFirstAPI.Models.Cart", b =>
                {
                    b.HasOne("EFFirstAPI.Models.Customer", "Customer")
                        .WithOne("Cart")
                        .HasForeignKey("EFFirstAPI.Models.Cart", "CustomerId")
            ...
            modelBuilder.Entity("EFFirstAPI.Models.CartItem", b =>
                {
                    b.HasOne("EFFirstAPI.Models.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFFirstAPI.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("EFFirstAPI.Models.OrderDetail", b =>
                {
                    b.HasOne("EFFirstAPI.Models.Order", "Order")
