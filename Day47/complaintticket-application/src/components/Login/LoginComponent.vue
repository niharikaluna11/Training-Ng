      ...
      <div class="row d-flex flex-column flex-md-row justify-content-center">
        ...
        <div class="col-lg-6">
          <div class="card2 card border-0 px-4 py-5">
            <div class="row h1 px-3 mb-4">
              Complaint Ticket Application Login Page
            </div> 
            <form @submit.prevent="login">
              <div class="row px-3">
                <label class="mb-1"><h6 class="mb-0 text-sm">Username</h6></label>
                <input class="mb-4 form-control" type="text" v-model="username" placeholder="Enter a valid Username" required>
              </div>
              <div class="row px-3">
                <label class="mb-1"><h6 class="mb-0 text-sm">Password</h6></label>
                <input type="password" class="form-control" v-model="password" placeholder="Enter password" required>
              </div>
              <div class="px-3 mb-4 d-flex flex-row">
                <a href="#" class="ml-auto mb-0 text-sm">Forgot Password?</a>
              </div>
              <div class="row mb-3 px-3">
                <button type="submit" class="btn btn-blue mb-0 text-center">Login</button>
              </div>
...
.card0 {
    box-shadow: 0px 4px 8px 0px #ffd1d4;
    border-radius: 0px;
}
