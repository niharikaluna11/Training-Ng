                ...
                <form @submit.prevent="saveProfileChanges" class="edit-form">
                    <div class="profile-info-content " :class="{ editing: isEditing }">
                        ...
                        <div class="ok2">
                            ...
                            <input type="text" v-model="editData.phone" id="phone" placeholder="phone number" />
                            ...
                            <textarea v-model="editData.preferences" id="preferences"
                                placeholder="preferences"></textarea>
