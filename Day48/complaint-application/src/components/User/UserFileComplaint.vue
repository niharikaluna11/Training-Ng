...
export default {
    ...
    async mounted() {
        ...
        if (username) {
            ...
            try {
                const userId = await getUserIdByUsername(username); // Await the asynchronous call
                console.log(userId);
                this.userId = userId;
                this.formData.userId = userId; // Assign the userId to formData
            } catch (error) {
    ...
    methods: {
        ...
        async submitComplaint() {
            ...
            try {
                ...
                this.$router.push("/userdashboard"); // Redirect to the view complaints page
            } catch (error) {
